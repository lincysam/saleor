...
# Fix: Remove this line or set it to empty string for Mailpit (no authentication)
USER_EMAIL_HOST_USER: str = user_email_config.get("EMAIL_HOST_USER") or ""

# Or if you want a default sender, use DEFAULT_FROM_EMAIL instead
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "noreply@localhost.com")
...
BUILTIN_PLUGINS = [
    ...
    "saleor.plugins.custom_channel_restriction.plugin.ChannelRestrictionPlugin", 
]

# Plugin discovery
EXTERNAL_PLUGINS = [
    "user_profile.plugin.UserProfilePlugin",
]
