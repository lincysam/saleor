...
class PluginsManager(PaymentInterface):
    ...
    def account_created(
        self, user: "User", input_data: dict, request=None):
        """Call the account_created hook."""
        return self._run_method_on_plugins(
            "account_created", None, user, input_data, request=request
        )
