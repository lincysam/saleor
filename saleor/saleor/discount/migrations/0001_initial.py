    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.DecimalField(decimal_places=3, default=Decimal('0.0'), max_digits=20)),
                ('amount_value', models.DecimalField(decimal_places=3, default=Decimal('0.0'), max_digits=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reward_value', models.DecimalField(blank=True, decimal_places=3, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countries', django_countries.fields.CountryField(blank=True, max_length=752, multiple=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('discount_value', models.DecimalField(decimal_places=3, max_digits=20)),
                ('currency', models.CharField(max_length=3)),
                ('min_spent_amount', models.DecimalField(blank=True, decimal_places=3, max_digits=20, null=True)),
            ],
            options={
                'ordering': ('pk',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.TextField(blank=True, null=True)),
                ('voucher_code', models.CharField(blank=True, max_length=255, null=True)),
                ('checkout', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='discounts', to='checkout.checkout')),
            ],
            options={
                'ordering': ('created_at', 'id'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voucher_code', models.CharField(blank=True, max_length=255, null=True)),
                ('unique_type', models.CharField(blank=True, choices=[('sale', 'Sale'), ('voucher', 'Voucher'), ('manual', 'Manual'), ('promotion', 'Promotion'), ('order_promotion', 'Order promotion')], max_length=64, null=True)),
                ('line', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='discounts', to='checkout.checkoutline')),
            ],
            options={
                'ordering': ('created_at', 'id'),
            },
