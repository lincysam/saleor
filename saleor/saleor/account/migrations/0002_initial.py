...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='staffnotificationrecipient',
            name='user',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='staff_notification', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddIndex(
            model_name='user',
        ...
        migrations.AddIndex(
            model_name='user',
            index=django.contrib.postgres.indexes.BTreeIndex(fields=['date_joined'], name='user_date_joined_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=django.contrib.postgres.indexes.BTreeIndex(fields=['email'], name='user_email_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=django.contrib.postgres.indexes.BTreeIndex(fields=['number_of_orders'], name='user_number_of_orders_idx'),
        ),
    ]
