...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='+', to='page.pagetype'),
        ),
        migrations.AddField(
            model_name='attribute',
            name='reference_product_types',
            field=models.ManyToManyField(blank=True, related_name='+', to='product.producttype'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='attribute',
            name='page_types',
            field=models.ManyToManyField(blank=True, related_name='page_attributes', through='attribute.AttributePage', through_fields=('attribute', 'page_type'), to='page.pagetype'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='attribute',
            name='product_types',
            field=models.ManyToManyField(blank=True, related_name='product_attributes', through='attribute.AttributeProduct', through_fields=('attribute', 'product_type'), to='product.producttype'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='references', to='product.category'),
        ),
        migrations.AddField(
            model_name='attributevalue',
            name='reference_collection',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='references', to='product.collection'),
        ),
        migrations.AddField(
            model_name='attributevalue',
            name='reference_page',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='attributesrelated', through='attribute.AssignedVariantAttribute', through_fields=('assignment', 'variant'), to='product.productvariant'),
        ),
        migrations.AddField(
            model_name='attributevariant',
            name='attribute',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='variant_attributes', through='attribute.AttributeVariant', through_fields=('attribute', 'product_type'), to='product.producttype'),
        ),
        migrations.AddField(
            model_name='assignedvariantattribute',
            name='assignment',
        ...
        migrations.AddIndex(
            model_name='attributevalue',
            index=django.contrib.postgres.indexes.BTreeIndex(fields=['numeric'], name='attribute_value_numeric_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='attributevalue',
