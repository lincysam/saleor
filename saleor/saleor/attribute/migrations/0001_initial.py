    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_type', models.CharField(choices=[('dropdown', 'Dropdown'), ('multiselect', 'Multi Select'), ('file', 'File'), ('reference', 'Reference'), ('single-reference', 'Single Reference'), ('numeric', 'Numeric'), ('rich-text', 'Rich Text'), ('plain-text', 'Plain Text'), ('swatch', 'Swatch'), ('boolean', 'Boolean'), ('date', 'Date'), ('date-time', 'Date Time')], default='dropdown', max_length=50)),
                ('entity_type', models.CharField(blank=True, choices=[('Page', 'Page'), ('Product', 'Product'), ('ProductVariant', 'Product Variant'), ('Category', 'Category'), ('Collection', 'Collection')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rich_text', saleor.core.db.fields.SanitizedJSONField(blank=True, null=True, sanitizer=saleor.core.utils.editorjs.clean_editor_js)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(db_index=True, editable=False, null=True)),
                ('page', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.CASCADE, related_name='attributevalues', to='page.page')),
            ],
            options={
                'ordering': ('sort_order', 'pk'),
            },
