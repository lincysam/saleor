    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(decimal_places=3, default=Decimal('0.0'), max_digits=20)),
                ('captured_amount', models.DecimalField(decimal_places=3, default=Decimal('0.0'), max_digits=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(max_length=3)),
                ('amount', models.DecimalField(decimal_places=3, default=Decimal('0.0'), max_digits=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(max_length=3)),
                ('charged_value', models.DecimalField(decimal_places=3, default=Decimal('0'), max_digits=20)),
                ('authorized_value', models.DecimalField(decimal_places=3, default=Decimal('0'), max_digits=20)),
                ('refunded_value', models.DecimalField(decimal_places=3, default=Decimal('0'), max_digits=20)),
                ('canceled_value', models.DecimalField(decimal_places=3, default=Decimal('0'), max_digits=20)),
                ('refund_pending_value', models.DecimalField(decimal_places=3, default=Decimal('0'), max_digits=20)),
                ('charge_pending_value', models.DecimalField(decimal_places=3, default=Decimal('0'), max_digits=20)),
                ('authorize_pending_value', models.DecimalField(decimal_places=3, default=Decimal('0'), max_digits=20)),
                ('cancel_pending_value', models.DecimalField(decimal_places=3, default=Decimal('0'), max_digits=20)),
                ...
                ('cc_first_digits', models.CharField(blank=True, max_length=4, null=True)),
                ('cc_last_digits', models.CharField(blank=True, max_length=4, null=True)),
                ('cc_brand', models.CharField(blank=True, max_length=40, null=True)),
                ('cc_exp_month', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(12)])),
                ('cc_exp_year', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(2000)])),
                ('payment_method_type', models.CharField(blank=True, choices=[('card', 'Card'), ('other', 'Other')], max_length=32, null=True)),
                ('payment_method_name', models.CharField(blank=True, max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_value', models.DecimalField(decimal_places=3, default=Decimal('0'), max_digits=20)),
                ('app_identifier', models.CharField(blank=True, max_length=256, null=True)),
                ('include_in_calculations', models.BooleanField(default=False)),
                ('app', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='app.app')),
                ('reason_reference', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='page.page')),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(fields=['token'], name='token_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='transactionitem',
            index=django.contrib.postgres.indexes.BTreeIndex(fields=['payment_method_type'], name='payment_method_type_ids'),
        ),
        migrations.AddIndex(
            model_name='transactionitem',
            index=django.contrib.postgres.indexes.BTreeIndex(fields=['cc_brand'], name='cc_brand_idx'),
        ),
