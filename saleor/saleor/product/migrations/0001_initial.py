    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='tax.taxclass')),
            ],
            options={
                'ordering': ('slug',),
        ...
        migrations.AddField(
            ...
            name='products',
            field=models.ManyToManyField(blank=True, related_name='collections', through='product.CollectionProduct', through_fields=('collection', 'product'), to='product.product'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discounted_price_amount', models.DecimalField(blank=True, decimal_places=3, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('currency', models.CharField(max_length=3)),
                ('price_amount', models.DecimalField(blank=True, decimal_places=3, max_digits=20, null=True)),
                ('cost_price_amount', models.DecimalField(blank=True, decimal_places=3, max_digits=20, null=True)),
                ('prior_price_amount', models.DecimalField(blank=True, decimal_places=3, max_digits=20, null=True)),
                ('discounted_price_amount', models.DecimalField(blank=True, decimal_places=3, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('discount_amount', models.DecimalField(decimal_places=3, default=Decimal('0.0'), max_digits=20)),
                ('currency', models.CharField(max_length=3)),
        ...
        migrations.AddIndex(
            model_name='category',
            index=models.Index(fields=['tree_id', 'lft'], name='product_category_tree_id_lf1e1'),
        ),
        migrations.AddConstraint(
            model_name='categorytranslation',
            constraint=models.UniqueConstraint(fields=('language_code', 'slug'), name='uniq_lang_slug_categorytransl'),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('language_code', 'slug'), name='uniq_lang_slug_collectiontransl'),
        ),
        migrations.AlterUniqueTogether(
            name='collectiontranslation',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('language_code', 'slug'), name='uniq_lang_slug_producttransl'),
        ),
        migrations.AlterUniqueTogether(
            name='producttranslation',
        ...
        migrations.AddIndex(
            model_name='productvariant',
            index=django.contrib.postgres.indexes.GinIndex(fields=['name', 'sku'], name='variant_gin', opclasses=['gin_trgm_ops', 'gin_trgm_ops']),
        ),
    ]
