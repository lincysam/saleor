...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('pk',),
                'indexes': [models.Index(fields=['checkout_line', 'reserved_until'], name='warehouse_p_checkou_3abf41_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('pk',),
                'indexes': [models.Index(fields=['checkout_line', 'reserved_until'], name='warehouse_r_checkou_b66369_idx')],
        ...
        migrations.AddIndex(
            model_name='warehouse',
            index=django.contrib.postgres.indexes.BTreeIndex(fields=['click_and_collect_option'], name='click_and_collect_option_idx'),
        ),
